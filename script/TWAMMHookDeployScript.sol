...
contract TWAMMHookScript is Script {
    ...
    function setUp() public {
        ...
        manager = IPoolManager(0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9);
        twammHook = IHooks(factory.mineDeploy(manager, 0));
        console.log("Deployed TWAMM hook to address %s", address(twammHook));
